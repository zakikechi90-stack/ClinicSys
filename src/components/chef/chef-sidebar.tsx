...
export function ChefSidebar() {
  ...
  const navItems = [
    { key: "dashboard", label: t.dashboard, href: "/chef", icon: LayoutDashboard },
    { key: "myPatients", label: t.myPatients, href: "/chef/patients", icon: Users },
    { key: "consultation", label: t.consultation, href: "/chef/consultation", icon: Stethoscope },
    { key: "history", label: t.history, href: "/chef/history", icon: History },
    { key: "monPlanning", label: "Mon Planning", href: "/chef/mon-planning", icon: Calendar },
    { key: "planning", label: t.planning, href: "/chef/planning", icon: Calendar },
  ]
